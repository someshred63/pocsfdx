trigger AGS_RSCH_MinNumUpdate on AGS_Relabel_Spend_Classification_gne__c (after update) {
    ...
    try
    {
        ...
        for(AGS_Relabel_Spend_Classification_gne__c sc: trigger.new)
        {
        ...
        {  
            if(trigger.old[i].Base_Category_Name_gne__c!=trigger.new[i].Base_Category_Name_gne__c||
                ...
                trigger.old[i].Base_Activity_Description_gne__c!=trigger.new[i].Base_Activity_Description_gne__c ||
                trigger.old[i].Base_Expense_Type_Name_gne__c !=trigger.new[i].Base_Expense_Type_Name_gne__c ||
                trigger.old[i].Speaker_Location_Type_Description_gne__c !=trigger.new[i].Speaker_Location_Type_Description_gne__c ||
                trigger.old[i].Label_Case_gne__c != trigger.new[i].Label_Case_gne__c ||
            ...
            { 
                ...
                if(rv!=null)
                {
                    ...
                    fieldNames.add('Base_Activity_Description_gne__c');
                    fieldNames.add('Base_Expense_Type_Name_gne__c');
                    fieldNames.add('Speaker_Location_Type_Description_gne__c');
                    fieldNames.add('Label_Case_gne__c');
