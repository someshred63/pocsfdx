trigger CMT_ShuttleBeforeDelete on CMT_Shuttle_gne__c (before delete) 
{
    ...
    CMT_MiscUtils.onDeleteTrigger ('CMT_Shuttle_gne__c', Trigger.old, parentMeetingIds);
}