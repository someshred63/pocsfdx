trigger CMT_TaxiCoBeforeDelete_gne on CMT_Taxi_Company_gne__c (before delete) 
{
    ...
    CMT_MiscUtils.onDeleteTrigger ('CMT_Taxi_Company_gne__c', Trigger.old, parentMeetingIds);
}