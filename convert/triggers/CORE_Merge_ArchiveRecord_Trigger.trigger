trigger CORE_Merge_ArchiveRecord_Trigger on CORE_Merge_Archive_Record__c (before delete) {
    if(!CORE_Merge_Util.isTriggerDisabled(CORE_Merge_Archive_Record__c.sObjectType)) {
